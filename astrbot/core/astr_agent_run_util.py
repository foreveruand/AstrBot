            ...
            async for resp in agent_runner.step():
                ...
                if resp.type == "tool_call_result":
                    ...
                    if agent_runner.streaming:
                        # End the current LLM response turn before the tool runs.
                        # The next LLM response turn starts a new streaming message,
                        # regardless of whether tool status messages are visible.
